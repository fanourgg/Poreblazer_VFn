...
module results
        ...
        !... calculation of VF1, VF2, VF3, VF4 (definitions)
        real*8 :: vf1, vf2, vf3, vf4
        integer :: sys_perc
end module results
...
subroutine helium_volume
    ...
    pore_v_he = 0.0
    !... calculation of VF2, VF3, VF4 (initialization)
    vf2 = 0.0
    vf3 = 0.0
    vf4 = 0.0
    ...
    do i=1, nhe_cubes
        ...
        !... calculation of VF2, VF3, VF4 (summation over all cubelets)
        vf2 = vf2 + bf**2
        vf3 = vf3 + bf**3
        vf4 = vf4 + bf**4
    end do
    ...
    !... calculation of VF2, VF3, VF4 (averaging)
    vf1 = pore_v_he
    vf2 = vf2 / dble(ntot)
    vf3 = vf3 / dble(ntot)
    vf4 = vf4 / dble(ntot)
    ...
    !... calculation of VF2, VF3, VF4 (print-out)
    write(*,'(a,f12.3)') " VF1:  ", vf1
    write(*,'(a,f12.3)') " VF2:  ", vf2
    write(*,'(a,f12.3)') " VF3:  ", vf3
    write(*,'(a,f12.3)') " VF4:  ", vf4
    write(*,*)
